...
const SuppliersPage: React.FC = () => {
    ...
    const fetchData = async () => {
        try {
          const response = await axios.get<Supplier[]>('http://localhost:3001/purchase-orders');
  ...
  const handleSearch = async () => {
    router.push(`/purchase-orders/${searchTerm}`);
  };
      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex-1 bg-gray-50 p-5">
          <div className="mb-4 flex items-center">
            <input
              type="text"
              placeholder="Search purchase Order by ID..."
              value={searchTerm}
        ...
        <Link href="/suppliers/addsupplier" className="text-blue-500 hover:underline"> 
